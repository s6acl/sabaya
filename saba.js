$(".dpnl").append(`<div id="mic"style="text-align: center;font-family: el messiri,FontAwesome!important;color: #0D184E; height: 100%;width:100%;"class="break light tab-pane border"></BR><p>شـات صبايا كول</p>  اذاعه شات صبايا للجوال  </p>$(`


<iframe src="https://mixlr.com/sabaya_fm/embed/?color=990000" width="100%" height="300px" scrolling="no" frameborder="no" marginheight="0" marginwidth="0"></iframe></p><img src="sico/z1ect2493d10.gif"style="width:%;margin-top: 0px;"></BR>ادارة الموقع</BR>  ـ</BR><center></div><center>

</div>`), $('#d0').append(`<label title="بث اذاعه صبايا"href="#"onclick="$('.pnhead').text($(this).attr('title'));hl($(this),'primary');setTimeout(function(){$('#mic').scrollTop(0);},0);$('.dpnl').show();"data-toggle="tab"data-target="#mic"class="ae fa label label-primary fa-tv"> </label>`);
